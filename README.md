Deploy a VM in Azure to be used as host for remote dev. To find out more, check [this blog post](https://tobiasfenster.io/remote-dev-with-vs-code-against-a-windows-host-is-easy-now)
